...
// I can only get this to work if it's a URI, not a filename - 

const context = 'http://127.0.0.1:8080/' + path.join('defaults', 'context.json');
...
module.exports = function(){
  ...
  return {
    ...
    to_html : function to_html() {
        ...
        index_maker.write_html(path.join(DEFAULTS, "catalog_template.html"), path.join(this.dir, "index.html"), text_citation);
    },
